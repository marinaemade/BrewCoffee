  ...
  return (
    <nav className={`navbar fixed top-0 left-0 w-full z-50 transition-all duration-500 px-4 md:px-20 ${
      ...
      <div className="navbar-start">
        ...
        <a className="text-xl md:text-2xl font-serif font-bold text-white cursor-pointer ml-2">
      ...
      <div className="navbar-center hidden lg:flex">
        <ul className="menu menu-horizontal px-1 text-white font-medium gap-6">
          <li><a className="hover:text-amber-200 transition-colors">Home</a></li>
          <li><a className="hover:text-amber-200 transition-colors">About</a></li>
          <li><a className="hover:text-amber-200 transition-colors">Menu</a></li>
        </ul>
      </div>

      <div className="navbar-end">
        <a className="btn bg-[#6F4E37] hover:bg-[#5D402E] border-none text-white rounded-full px-4 md:px-8 capitalize text-sm md:text-base">
          Contact Us
        </a>
      </div>
      ...
      <div className={`lg:hidden absolute top-[100%] left-0 w-full bg-black/95 backdrop-blur-xl transition-all duration-500 overflow-hidden ${
        ...
        <ul className="menu menu-vertical p-8 text-white text-xl gap-4 font-serif">
          <li><a onClick={() => setMenuOpen(false)}>Home</a></li>
          <li><a onClick={() => setMenuOpen(false)}>About</a></li>
          <li><a onClick={() => setMenuOpen(false)}>Menu</a></li>
        </ul>
      </div>
    </nav>
  );
